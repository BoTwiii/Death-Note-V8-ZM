precacheoptions()
{
    AddMenu("none", "main", "^1Death Note V8");
    ...
    switch(menuId)
    {
        case "main":
            ...
            AddSubmenu(menuId, "PS4 Options", "PS4 JB Account Options");
            ...
            {
                AddOption(menuId, "Award 25 " + GetModeCurrency(), serious::AdjustCurrency, player, 25);
                AddOption(menuId, "Give " + GetModeCurrency() + " Loop", serious::AdjustCurrency, player, -1);
            }
            //            AddOption(menu, "All Achievements", serious::GiveAllAchievements, player);

             AddOption(menuId, "Unlock All Achivements", serious::UnlockAchievements, player);
             AddOption(menuId, "Set Clan Tag To ^1Red", ::ClanTagEditor, "Red");
             AddOption(menuId, "Set Clan Tag To ^2Green", ::ClanTagEditor, "Green");
             AddOption(menuId, "Set Clan Tag To ^3Yellow", ::ClanTagEditor, "Yellow");
             AddOption(menuId, "Set Clan Tag To ^4Dark Blue", ::ClanTagEditor, "DB");
             AddOption(menuId, "Set Clan Tag To ^5Cyan", ::ClanTagEditor, "Cyan");
             AddOption(menuId, "Set Clan Tag To ^6Pink", ::ClanTagEditor, "Pink");
        case "personal":
